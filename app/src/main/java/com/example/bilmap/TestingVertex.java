...
//    int[] images = {R.drawable.b_floor_0, R.drawable.b_floor_1, R.drawable.b_floor_2, R.drawable.b_floor_3, R.drawable.b_floor__1};//
    ...
    //This part will be used for the floor detection with sensors
//    private Timer timer;
...
//            txt.setText(String.format("%.3f nbar", values[0]));
//        }
//
//        @Override
...
//    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // imgview =(ImageView) findViewById(R.id.showNav);
...
//            public void run() {
//
//                if(Integer.valueOf(txt.getText().toString()) > 800 )
//                    currentimage = 2;
...
//        // ######################### END OF B BUILDING ##########################
        ...
        //Navigation.navigate( context, firstRoom, secondRoom, scan);
//        Navigation.navigate( context, b105, b105, scan);
...
//    public TestingVertex(Room firstRoom, Room secondRoom, Scanner scan) {
//        Context context = this;
